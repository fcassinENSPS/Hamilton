...
def recupHamilton():
    ...
    if choixPhi.get() == 0:
        ...
        h = Hamilton(eta,float(entrA.get()),float(entrrho.get()),int(entrnb.get()),int(entrM.get()),int(entrdx.get()),int(entrdy.get()),float(entrT.get()),float(entrdt.get()),choixInt.get(),choixInitialisation.get(),choixOrdreGyro.get(),choixOrdreFLR.get(),int(entrnth.get()))
...
Label(fen1, text = 'Initialisation particules').grid(row = 0, column = 2, padx = 2, pady = 2, columnspan = 1)
...
initAleatoire.grid(row = 1, column = 2, padx = 2, pady = 5)
initGrille.grid(row = 2, column = 2, padx = 5, pady = 5)

choixOrdreGyro = IntVar()
choixOrdreGyro.set(1)
Label(fen1, text = 'Ordre Gyro').grid(row = 3, column = 2, padx = 2, pady = 2, columnspan = 1)
...
ordre1Gyro.grid(row = 4, column = 2, padx = 2, pady = 5)
ordre2Gyro.grid(row = 5, column = 2, padx = 5, pady = 5)
